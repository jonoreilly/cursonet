...
function fMenu (aNumerosAux)
{
  ...
  while (!bExitAux)
  {
    var iSeleccion = prompt("Que quieres hacer? \n\n"+
                            "  1. Mostrar el Mayor \n"+
...
{
  var iMayorAux = aNumerosAuxAux[0];
  for (var i = 1; i < aNumerosAuxAux.length; i++)
  {
...
function fSumaParesImpares (aNumerosAuxAux)
{
  ...
  for (var i = 0; i < aNumerosAuxAux.length; i++)
  {
    ...
    {
      iSumaImpares += aNumerosAuxAux[i];
    }
    else
    {
      iSumaPares += aNumerosAuxAux[i];
    }
  }
